...
# test diagnostic plot looking at SWBR the Sweet Briar College site
...
# Need to likely make a functoion that goes through data and finds any value that is less than a value,
